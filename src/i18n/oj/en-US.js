export const m = {
  ...
  Rate_Website: 'Rate this Online Judge Website',
  Review_Description: 'Please provide your honest feedback about your experience with this online judge platform during the contest.',
  Overall_Rating: 'Overall Rating',
  Category_Ratings: 'Detailed Ratings',
  User_Interface: 'User Interface',
  Performance: 'Performance',
  Problem_Quality: 'Problem Quality',
  Judging_Accuracy: 'Judging Accuracy',
  Documentation: 'Documentation',
  Written_Review: 'Written Review',
  Review_Placeholder: 'Share your experience with this online judge platform. What did you like? What could be improved? Your feedback helps make the platform better for everyone.',
  Additional_Questions: 'Additional Questions',
  Would_Recommend: 'Would you recommend this platform to other competitive programmers?',
  Yes: 'Yes',
  No: 'No',
  Technical_Issues: 'Did you experience any technical issues during the contest?',
  No_Issues: 'No issues',
  Some_Issues: 'Some issues',
  Describe_Issues: 'Please describe the technical issues you experienced',
  Update_Review: 'Update Review',
  Submit_Review: 'Submit Review',
  Edit_Review: 'Edit Review',
  Your_Review: 'Your Review',
  Submitted_At: 'Submitted at',
  Recommends_Platform: 'Recommends this platform',
  Does_Not_Recommend: 'Does not recommend this platform',
  Review_Required_Warning: 'Review Required',
  Penalty_Warning: 'Failure to submit a review before the contest ends will result in a 60-minute penalty added to your total time.',
  Review_Submitted_Success: 'Thank you for your review! Your feedback has been submitted successfully.',
  Please_Complete_Required_Fields: 'Please complete all required fields (rating and review text).',
